...
public class TelaRelatorioGastos extends javax.swing.JFrame {
    ...
    public static void listar() {
        ...
        if (model.getRowCount() == 0) {
            for (Despesa d : lista) {
                model.addRow(new Object[]{d.getId(), d.getNome(), d.getValor(), d.getTipo(), d.getCategoria(), d.getStatus()});
            }
        }
        if (ListaDespesas.listar().isEmpty()) {
            for (Despesa d : lista) {
    ...
    private void tFiltroCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_tFiltroCaretUpdate
        ...
        if (tFiltro.getText().equals("") && count == 0) {
            ...
            for (Despesa d : ListaDespesas.listar()) {
                if (d.getCategoria().equals(tFiltro.getText())) {
                    model.addRow(new Object[]{d.getId(), d.getNome(), d.getValor(), d.getTipo(), d.getCategoria(), d.getStatus()});
                }
            }
        }
            ...
            try {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    if (!line.equals("id nome valor tipo categoria status") && !line.startsWith("_")) {
                        Despesa despesa = new Despesa(Integer.parseInt(colunas[0]), colunas[1], Double.parseDouble(colunas[2]), colunas[3], colunas[4], colunas[5]);
                        ListaDespesas.adicionar(despesa);
